                ...
                <form method="POST" action="{{ route('transactions.update', $transaction) }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <x-text-input id="description" name="description" type="text"
                                      class="mt-1 block w-full" value="{{ old('description', $transaction->description) }}" />
                    ...
                    <div>
                        ...
                        <x-text-input id="payee" name="payee" type="text"
                                      class="mt-1 block w-full" value="{{ old('payee', $transaction->payee) }}" />
                    ...
                    <div>
                        ...
                        <textarea id="notes" name="notes" rows="2"
                                  class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-sm">{{ old('notes', $transaction->notes) }}</textarea>
